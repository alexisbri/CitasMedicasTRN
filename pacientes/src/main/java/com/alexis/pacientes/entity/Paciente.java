package com.alexis.pacientes.entity;
...
public class Paciente {
    ...
    @JdbcTypeCode(SqlTypes.NAMED_ENUM) // Con esto se puede mapear un objeto enum en postgreSQL
    ...
    private void validarDatos(String nombre, String apellidoPaterno, String apellidoMaterno, String email,
        ...
        ValoresNumericosUtils.validarRangoShort(edad, (short) 1, (short) 100,
                "La edad es requerida y debe ser de 1 a 100 años");
