...
public record PacienteRequest(
    ...
    @DecimalMin(value = "1.0", message = "El peso debe ser mayor que 1kg")
    @DecimalMax(value = "200", message = "El peso maximo permitido es de 200 kg")
    Double peso,

    @NotNull(message = "La estatura es requerida")
    @DecimalMin(value = "1.0", message = "La estatura debe ser mayor que 1 metro")
    @DecimalMax(value = "2.0", message = "La estatura maxima permitida es de 2 metros")
    Double estatura,
